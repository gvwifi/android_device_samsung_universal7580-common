...
class Vibrator : public BnVibrator {
  public:
    ...
    ndk::ScopedAStatus getSupportedPrimitives(
            std::vector<CompositePrimitive>* supported) override;
  ...
  private:
    ...
    static uint32_t effectToMs(Effect effect, bool* supported);
    static float strengthToAmplitude(EffectStrength strength, bool* supported);
